...
public class InputController {
    ...
    private final Vector2 stickDirec;
    /**
...
//		tertiaryPressed = xbox.getLBumper();
        ...
        secondaryPressed = stickDirec.x > .6f || stickDirec.x < -.6f || stickDirec.y > .6f || stickDirec.y < -.6f;
    ...
    private void readKeyboard(Rectangle bounds, Vector2 scale, boolean secondary) {
        ...
        thrusterApplied = (secondary && thrusterApplied);
