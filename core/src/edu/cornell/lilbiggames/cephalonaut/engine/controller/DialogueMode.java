...
public class DialogueMode {
    ...
    private final Texture nextIcon;
    private final Texture AD_KEY;
    private final Texture W_KEY;
    private final Texture SPACE_KEY;
    private final Texture RIGHT_CLICK;
    private final Texture LEFT_CLICK;
    private final FilmStrip W_KEY_strip;
