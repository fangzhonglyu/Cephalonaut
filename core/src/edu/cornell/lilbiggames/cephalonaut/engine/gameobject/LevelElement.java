...
public class LevelElement extends SimpleObstacle {
    ...
    public static LevelElement create(Def def) {
        switch (def.element) {
            ...
            case ENGINE:
                System.out.println("dsafdfdsf");
                return new LEAnimated(def,new FilmStrip(engineTexture,1,6),5);
            case BROKEN_ENGINE:
                return new LEAnimated(def,new FilmStrip(brokenEngineTexture,1,6),5);
            default:
